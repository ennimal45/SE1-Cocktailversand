...
Dieses Visions-Dokument bezieht sich auf das System Liefer Colada, das vom Team 3Promille entwickelt wird. Das System wird dem Barbesitzer erlauben, unseren Online-Shop zu nutzen, um damit jeden Cocktaillieberhaber zu erreichen, den Zugang zu den Cocktails zu erleichtern und eigene Cocktailkrationen zu ermöglichen. 
...
|===
| Für | die kleine Bar
| die | Cocktails auch online verschicken mag
| ist das  | Liefer Colada
| ein  | Onlineshop
| der | das Barfeeling für zu Hause bietet und Kriesenschtz
| anders als | nur Lokalverkauf
| kann unser Produkt | jeden erreichen
|===
...
| Kunden / Barbetreiber
| Inhaber der kleinen Bar und er möchte seine Cocktails außerhalb der Bar zum Verkauf haben
| beauftrag Entwicklung, gibt uns Vorgaben für das System und finanziert uns

| Nutzer 
| will auch außerhalb der Bar seine lieblingscocktail trinken und eigene Kreationen kreieren
| benutzt das System und will das System einfach verstehen
...
| Gesetzgeber
| nervt
| gibt rechtliche Rahmenbedingungen vor, überprüft den AGB, Jugendschutz, Datenschutz und Datensicherheit

| Lieferant
| liefert Cocktails
| nutzt Daten zur Auslieferung
...
| 
| Schnittstelle festlegen und Preis beeinflussen
