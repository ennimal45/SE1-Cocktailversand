...
Dieses Visions-Dokument bezieht sich auf das System Liefer Colada, das vom Team 3Promille entwickelt wird. Das System wird es Barbesitzer erlauben, unseren Online-Shop zu nutzen, um damit jeden Cocktaillieberhaber zu erreichen, den Zugang zu den Cocktails zu erleichtern und eigene Cocktailkrationen zu ermöglichen. 
...
|===
| Für | die kleine Bar
| der / die | Cocktails auch online verschicken mag
| ist das  | Liefer Colada
| ein  | Onlineshop
| der / die | das Barfeeling für zu Hause bietet und Kriesenschtz
...
| gibt uns Vorgaben für das System und finanziert uns
...
| Gesetzgeber
| nervt
| gibt rechtliche Rahmenbedingungen vor, überprüft den AGB, Datenschutz und Datensicherheit
